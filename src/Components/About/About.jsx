                ...
                <div className="row">
                    ...
                    <div className="about-col-2">
                        ...
                        <div className="tab-para">
                            <p>Hi,  I'm Kenil Chovatiya, as a fresher with a strong foundation in HTML, CSS, and JavaScript, I specialize in creating responsive, user-friendly web interfaces that deliver an exceptional user experience. I enjoy transforming ideas into reality through clean, efficient code and modern design principles.</p>
                        ...
                        <div className="skills-content">
                            ...
                            <div className="progress">
                                ...
                                <div className="progress-bar-wrap">
                                    <div style={{ width: "600%" }} className="progress-bar" role="progressbar"></div>
                                </div>
                            </div>
